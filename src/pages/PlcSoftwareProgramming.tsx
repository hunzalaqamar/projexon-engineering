...
const PlcSoftwareProgramming: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 overflow-hidden">
      ...
      <header
        ...
        style={{
          backgroundImage: `url('/assets/plcprogbg.jpg')`, // Replace with actual high-quality hero image
        }}
      >
        <div
        ...
        >
          ...
          >
            ...
            <p className="text-2xl mb-8 font-light drop-shadow-md">
              Driving Automation with Precision
            </p>
            <motion.button
        ...
        <section className="space-y-16">
          ...
          >
            <h2 className="text-4xl font-semibold text-[#2b49a1] mb-6 tracking-tight">
              Custom PLC Solutions for Enhanced Efficiency
            </h2>
            <p className="text-gray-800 text-xl leading-relaxed">
              Our PLC Software Programming service delivers custom programming,
              automation solutions, and system integration to enhance process
              efficiency and control. Using Siemens PLC cards, Allen Bradley
              systems, and other cutting-edge technologies, we develop tailored
              software to automate industrial processes, reduce errors, and
              improve productivity. Projexon Engineering ensures seamless
              integration with existing systems, driving innovation for
              industries like textile, food & beverage, and power.
            </p>
          </motion.div>
...
export default PlcSoftwareProgramming;
