  ...
  return (
    <div className="min-h-screen bg-gray-50 overflow-hidden">
      ...
      <header
        ...
        style={{
          backgroundImage: `url('/assets/engservicesbg.jpg')`, // Replace with actual high-quality hero image
        }}
      >
        <div
        ...
        >
          ...
          >
            ...
            <p className="text-2xl mb-8 font-light drop-shadow-md">
              Total Support for Your Industry Needs
            </p>
            <motion.button
        ...
        <section className="space-y-16">
          ...
          >
            ...
            <p className="text-gray-800 text-xl leading-relaxed">
              Our Engineering Services provide comprehensive support, including
              maintenance, upgrades, and technical solutions for various
              industries. Projexon Engineering ensures your operations run
              smoothly with tailored services like system optimization,
              preventive maintenance, and technical troubleshooting. Utilizing
              advanced technologies such as MAC Valves, PISCO Pneumatics, and
              Siemens PLCs, we deliver sustainable, cost-effective solutions for
              oil & gas, textile, food & beverage, and more, driving long-term
              success.
            </p>
          </motion.div>
