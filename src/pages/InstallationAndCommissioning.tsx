...
const InstallationAndCommissioning: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 overflow-hidden">
      ...
      <header
        ...
        style={{
          backgroundImage: `url('/assets/installationbg.jpg')`, // Replace with actual high-quality hero image
        }}
      >
        <div
        ...
        >
          ...
          >
            ...
            <p className="text-2xl mb-8 font-light drop-shadow-md">
              Ensuring Flawless Industrial Operations
            </p>
            <motion.button
        ...
        <section className="space-y-16">
          ...
          >
            ...
            <p className="text-gray-800 text-xl leading-relaxed">
              Projexon Engineering provides professional installation and
              commissioning of machinery, equipment, and industrial systems to
              ensure seamless operation from day one. Our skilled technicians
              handle everything from setup to testing, using advanced tools like
              Allen Bradley drives and Siemens PLC systems. We guarantee
              reliability, safety, and efficiency, minimizing downtime and
              maximizing productivity for industries such as power, chemical,
              and manufacturing.
            </p>
          </motion.div>
