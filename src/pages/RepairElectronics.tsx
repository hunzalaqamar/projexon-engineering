...
const RepairElectronics: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 overflow-hidden">
      ...
      <header
        ...
        style={{
          backgroundImage: `url('/assets/repairbg.jpg')`, // Replace with actual high-quality hero image
        }}
      >
        <div
        ...
        >
          ...
          >
            ...
            <p className="text-2xl mb-8 font-light drop-shadow-md">
              Restoring Functionality with Precision
            </p>
            <motion.button
        ...
        <section className="space-y-16">
          ...
          >
            ...
            <p className="text-gray-800 text-xl leading-relaxed">
              Projexon Engineering’s Repair Electronics service offers
              troubleshooting, diagnosing, and repairing industrial electronic
              equipment and circuit boards to restore functionality. Our skilled
              technicians use advanced diagnostic tools to identify faults in
              PLCs, servo drives, and other electronic components, ensuring
              quick and effective repairs. We minimize downtime for industries
              like pharmaceutical, chemical, and power, delivering long-lasting
...
export default RepairElectronics;
